...
UserPrincipal là một class của Java, được sử dụng để đại diện cho người dùng, được xác định bằng tên đăng nhập. Trong trường hợp này,
UserPrincipal được sử dụng để đại diện cho người dùng được xác định bằng một ID ngẫu nhiên.*/
